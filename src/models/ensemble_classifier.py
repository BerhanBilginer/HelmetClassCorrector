...
Ensemble classifier (Feature + CNN) kaldırıldı. Inference ve eğitimde
...
import warnings
warnings.warn(
    "ensemble_classifier.py is deprecated. Use cnn_classifier.py instead.",
    DeprecationWarning,
    stacklevel=2,
)
...
class EnsembleClassifier:
    ...
    def load_cnn_model(self, model_path):
        ...
        """
        self.cnn_classifier = CNNClassifier(model_type='efficientnet')
